    ...
    >
      <div className="max-w-6xl w-full mx-auto flex flex-col gap-12 text-center md:text-left">
        <div className="max-w-xl mx-auto md:mx-0">
          <h1 
            className="text-4xl md:text-8xl font-black uppercase tracking-tighter leading-[0.8] mb-8"
          ...
          <p className="text-sm md:text-lg text-white/50 font-sans leading-relaxed max-w-sm mb-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-12 w-full mt-auto">
          <button className="bg-white text-black px-12 py-4 rounded-full uppercase tracking-widest font-sans text-xs font-bold hover:bg-gray-200 transition-all hover:scale-105 active:scale-95 flex items-center gap-4">
          ...
          <div className="flex gap-8 text-[10px] md:text-xs uppercase tracking-[0.25em] text-white/30 font-sans">
